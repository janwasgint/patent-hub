...
class VerifyData extends Component {
  ...
  onClick = (e) => {
    ...
    var employeeAddr = this.state.value;

    getContract(this.context.drizzle)
      .then(function(instance) {
        return instance.VerifyData(employeeAddr, { from: account });
      })
      .then(function(result) {
        alert('Data Verification request sent successfully! Transaction Hash: ' + result.tx);
        console.log(result);
      })
      .catch(function(err) {
